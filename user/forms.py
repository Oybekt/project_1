...
class SignUpForm(UserCreationForm):
    ...
    password1 = forms.CharField(
        ...
        help_text="<small> Katta va kichik <b>harflar</b>, <b>raqamlar</b>, <b>8ta</b> belgidan iborat bo'lishi kerak.</small>",
    )
...
class CustomLoginForm(AuthenticationForm):
    ...
    password = forms.CharField(
        label=_("Parol"),
        strip=False,
        widget=forms.PasswordInput(attrs={"class": "form-control mb-3", "placeholder": "*********"}, ),
    )
    ...
    error_messages = {
        ...
        "inactive": _("Ushbu accuont faol emas."),
    }
